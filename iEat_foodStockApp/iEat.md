...
- ### App Improvements
- **Cloud backup** Since th qe users inforamtion and item information are currently stored in the local disk(PyCharm file) so it's risky for all those information 
- **Functionalities**
